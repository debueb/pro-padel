    ...
    <div class="col-xs-8 booking-cell">
        <c:forEach var="Player" items="${Model.players}" varStatus="status">
            ...
            <div class="${status.first ? '' : 'unit'}">
                <jsp:include page="/WEB-INF/jsp/players/include/profile-image.jsp"><jsp:param name="includeName" value="true"/></jsp:include>
                </div>
        </c:forEach>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-xs-8 booking-cell"><joda:format value="${Model.startTime}" pattern="HH:mm"/> - <joda:format value="${Model.endTime}" pattern="HH:mm"/></div>
</div>