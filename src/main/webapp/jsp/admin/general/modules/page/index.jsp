    ...
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-lg-8 col-lg-offset-2">
        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                    ...
                    <tbody class="table-sortable">
                        <c:forEach var="Model" items="${Models}">
                            ...
                            <tr data-id="${Model.id}">
                                ...
                                <td class="delete"><a href="/admin/general/modules/page/${Module.id}/${Model.id}/delete" class="fa fa-minus-circle"></a></td>
                            </tr>
                        </c:forEach>
                    </tbody>
                </table>
                ...
                <a class="no-ajaxify btn btn-primary btn-block unit" href="/admin/general/modules/page/${Module.id}/add"><fmt:message key="AddEntry"/></a>
            </div>
        </div>
    </div>
</div>
