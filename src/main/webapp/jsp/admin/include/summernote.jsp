...
<script src="/js/noconcat/summernote.min.js"></script>
<script src="/js/noconcat/summernote-ext-template.js"></script>
<script src="/js/noconcat/summernote-map-plugin.js"></script>
