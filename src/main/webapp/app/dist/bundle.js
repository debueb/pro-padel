...
var project = __webpack_require__(1);
...
(function ($) {
  ...
  DayScheduleSelector.prototype.serialize = function () {
    ...
    $.each(this.options.days, function (_, v) {
      ...
      start = end = false,
      selection = {"weekDay": v, "scheduleSlots": []};
      plugin.$el.find(".time-slot[data-day='" + v + "']").each(function () {
        ...
        if (!!end) { 
            selection.scheduleSlots.push({"startTime": start, "endTime": end}); 
            start = end = false;
        }
      });
  ...
  DayScheduleSelector.prototype.deserialize = function (schedule) {
    ...
    $.each(schedule, function(d, ds) {
      var $slots = plugin.$el.find('.time-slot[data-day="' + ds["weekDay"] + '"]');
      $.each(ds.scheduleSlots, function(_, s) {
        for (i = 0; i < $slots.length; i++) {
          if ($slots.eq(i).data('time') >= s.endTime) { break; }
          if ($slots.eq(i).data('time') >= s.startTime) { plugin.select($slots.eq(i)); }
        }
      });
    });
  };
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;/*! jQuery UI - v1.12.0 - 2016-07-26
* http://jqueryui.com
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;/*! jquery.livequery - v1.3.6 - 2016-12-09
 * Copyright (c)
 ...
 *  Under MIT License
 */
!function(a,b,c){"use strict";!function(b){ true?!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(0)], __WEBPACK_AMD_DEFINE_FACTORY__ = (b),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
