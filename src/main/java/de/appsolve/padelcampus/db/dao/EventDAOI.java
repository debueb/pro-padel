...
public interface EventDAOI extends BaseEntityDAOI<Event> {
    ...
    Event findByIdFetchWithParticipantsAndCommunities(Long id);
    ...
    List<Event> findAllFetchWithParticipantsAndCommunities();
    ...
    List<Event> findAllForEventOverviewActiveStartingWith(LocalDate date);
