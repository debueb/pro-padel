...
public class LoginController extends BaseController{
    ...
    public ModelAndView forgotPassowrd(@Valid @ModelAttribute("Model") Credentials credentials, BindingResult bindingResult, HttpServletRequest request){
        ...
        mail.setBody(StringEscapeUtils.unescapeJava(msg.get("ForgotPasswordMailBody", new Object[]{player.getDisplayName(), resetPasswordURL, RequestUtil.getBaseURL(request)})));
        try {
            MailUtils.send(mail);
