 ...
 * @author dominik
 */
public class BookingExternalVoucherRegisterTest extends TestBase {

    @Test
    public void testBookingWorkflowCreditCardRegister() throws Exception {
        LOG.info("Test booking workflow [paymentMethod: ExternalVoucher, bookingType: register]");
        ...
        mockMvc.perform(post("/bookings/" + nextMonday + "/10:00/offer/" + offer1.getId())
                ...
                .param("duration", "60")
                .param("paymentMethod", PaymentMethod.ExternalVoucher.name()))
