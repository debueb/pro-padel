...
public abstract class TestBookingVoucher extends TestBase{
    ...
    protected void bookViaVoucherAndNoLogin() throws Exception {
        ...
        Voucher testVoucher = VoucherUtil.createNewVoucher("test voucher", 60L, getNextMonday(), validFromTime, validUntilTime, CalendarWeekDay.valuesAsSet());
